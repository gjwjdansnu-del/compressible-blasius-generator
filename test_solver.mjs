...
]){const r=solveBaseflow(c);assert.ok(r.meta.solution_summary.boundary_residual_max<1e-7);assert.ok(r.data.every(d=>Number.isFinite(d.u_over_ue)&&d.T_over_Te>0));console.log(c.mach,c.wall,r.meta.solution_summary)}
